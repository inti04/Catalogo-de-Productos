// Este script maneja la carga de imágenes y el envío de un formulario para agregar productos a la base de datos.
// Permite la vista previa de las imágenes seleccionadas y envía los datos del formulario a la API.
